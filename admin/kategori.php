        ...
        <div class="container-fluid">
          ...
          <form action="kategori.php" method="get">
            <div class="input-group" align="right">
              <input align="right" name="cari" type="text" class="form-control bg-light border-0 small" placeholder="Search Kategori..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">Data Kategori 
              <button type="button" onclick="window.location.href='input_kategori.php'" class="btn btn-success" style="float: right;"><i class="fas fa-plus"></i> Tambah</button>
              </h3>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                      ...
                      if (isset($_GET['cari'])) {
                        $cari = $_GET['cari'];
                        $data = mysqli_query($koneksi, "SELECT * from kategori where nama_kategori like '%".$cari."%'") or die (mysql_error($koneksi));
                      foreach ($data as $baris) { ?>
                        <tr>
                            <td><?php echo $baris['kode_kategori'] ?></td>
                            <td><?php echo $baris['nama_kategori'] ?></td>
                            <td align="center"><?php echo $baris['no_rak'] ?></td>
                            <td width="191"><a class="btn btn-primary" href="ubah_kategori.php?kode_kategori=<?php echo $baris['kode_kategori'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="hapus_kategori.php?kode_kategori=<?php echo $baris['kode_kategori'] ?>">Hapus</a>
        </div>
      </div>
    </div>
  </div>
