        ...
        <div class="container-fluid">
          ...
          <!-- Search -->
            <div class="input-group" align="right">
              <input align="right" type="text" class="form-control bg-light border-0 small" placeholder="Search Kode Barang..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <button type="button" onclick="window.location.href='input_barang.php'" class="btn btn-primary" style="float: right;">Add</button>
              </h3>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      ...
                      foreach ($data as $baris) { ?>
                        <tr>
                            ...
                            <td><a class="btn btn-primary" href="ubah_barang.php?kode_barang=<?php echo $baris['kode_barang'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                              <a class="btn btn-danger" href="hapus_barang.php?kode_barang=<?php echo $baris['kode_barang'] ?>"><i class="fa fa-trash" aria-hidden="true"></i> Hapus</a></td>
                        </tr>
                    <?php
                      }
                    ?>
