...
function mei(){
  ...
  function oktober(){
    ...
    $sa_queryoktober = mysqli_query($koneksi, "SELECT sum(jumlah) as jumlah from barang_masuk where month(tanggal_masuk) < 10");
  ...
  function desember(){
    ...
    $sa_querydesember = mysqli_query($koneksi, "SELECT sum(jumlah) as jumlah from barang_masuk where month(tanggal_masuk) < 12");
