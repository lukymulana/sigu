      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form>
            <div class="input-group" align="right">
              <input align="right" type="text" name="cari" class="form-control bg-light border-0 small" placeholder="Search User..." aria-label="Search" aria-describedby="basic-addon2">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Data User 
                <button type="button" onclick="window.location.href='input_user.php'" class="btn btn-success" style="float: right;"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</button>
              </h3>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      ...
                      foreach ($data as $baris) { ?>
                        <tr>
                            ...
                            <td width="191"><a class="btn btn-primary" href="ubah_user.php?user_id=<?php echo $baris['user_id'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
        ...
        <?php
            if (isset($_GET['cari'])) {
              $cari = $_GET['cari'];
              echo '
                <a target="_blank" type="button" href="cetak_user.php?cari='.$cari.'" class="btn btn-primary" style="margin-left: 1000px;"><i class="fa fa-print"> Cetak Data</i></a>';
            }else{
              echo '
                <a target="_blank" type="button" href="cetak_user.php" class="btn btn-primary" style="margin-left: 1000px;"><i class="fa fa-print"> Cetak Data</i></a>';
            }
         ?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="hapus_user.php?user_id=<?php echo $baris['user_id'] ?>">Hapus</a>
        </div>
      </div>
    </div>
  </div>
